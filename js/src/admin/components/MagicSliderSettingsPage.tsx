              ...
              <div className="Form-group">
                <div className="MagicSlides-toolbar">
                  <Button className="Button Button--primary" onclick={() => this.add()}>
                    {icon('fas fa-plus')} {app.translator.trans('forumaker-magicslider.admin.settings.add_slide')}
                  </Button>
                </div>
                ...
                <div className="MagicSlides-list">
                  {this.slides.map((s, i) => (
                    <div key={i} className="MagicSlides-item" data-index={i} draggable="true">
                      <span className="MagicSlides-handle" title={app.translator.trans('forumaker-magicslider.admin.settings.drag')}>
